...
class QAOACircuitGenerator():
    @classmethod
    def genQaoaMaxcutCircuitTemplate(cls, graph, initial=None, p=1, measure=True, suppressClassicalRegister=False):
        # prepare the quantum and classical resisters
        n_vertices = graph.shape[0]
        registers = (n_vertices,) if suppressClassicalRegister else (n_vertices, n_vertices)
